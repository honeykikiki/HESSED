...
## 멤버리스트 이미지 넘기기 버벅임 UX측면 불편함이 해소하기

    문제 : 멤버리스트 이미지 넘기기 버벅임 UX측면 불편함이 해소하기
    해결 : 부드럽게 만들기에 코드 짜는 시간도 많아지고 코드가 길어져 가독성도 않좋아
          해결방법으로 swiper라이브러리를 활용해서 해결하였다
